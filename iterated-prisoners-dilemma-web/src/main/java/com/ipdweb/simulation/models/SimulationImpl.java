...
import com.ipdweb.exceptions.LockedSimulationException;
import com.ipdweb.simulation.interfaces.Generation;
import com.ipdweb.simulation.interfaces.Simulation;
...
public class SimulationImpl implements Simulation {
    ...
    private boolean isLocked; //locks simulation for addition or removal of strategy after its started.
    ...
    public String print(int genNum, boolean isVerboseMode) {
        ...
        sb.append(String.format("   Tournament %d:", genNum + 1))
